<template>
	<view class="content">
		<view class="inner">
			<view class="inner_item" style="height: 200rpx;">
				<view class="item_title" style="height: 200rpx; line-height: none;">
					食物内容:
				</view>
				<view class="item_input textInput">
					<textarea v-model="food" placeholder="请输入食物内容" />
				</view>
			</view>
